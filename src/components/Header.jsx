    ...
    return (
        <header className='' ref={headerRef}>
            ...
            <div className='flex justify-end items-center'>
                <a className="hf-link-container group" href="#" >
                    <div className='hf-link-text text-clamp-small flex items-center justify-center gap-1.25 py-1 px-1.25'>
                        <span>cart</span>
                        <svg className='w-[clamp(8.4px,.74dvw,13.5px)] aspect-square fill-black group-hover:fill-white transition-all duration-300 ease-linear' viewBox="0 0 15 15" fill="black" xmlns="http://www.w3.org/2000/svg">
